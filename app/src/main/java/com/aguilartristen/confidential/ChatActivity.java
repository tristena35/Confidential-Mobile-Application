...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mChatMessageView.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                if (!s.toString().isEmpty()) {
                    // * Instead of try adding an item under instead then deleting it? *
                    TYPING_STATE = 1;
        ...
        // Once the user enters the chat, mark seen under your conversation with them
        ...
        mRootRef.child("Chat").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if(!dataSnapshot.hasChild(mChatUser)){
                    // Map for seen feature
                    Map chatAddMap = new HashMap();
                    chatAddMap.put("seen", false);
                    chatAddMap.put("timestamp", ServerValue.TIMESTAMP);
                    chatAddMap.put("typing", 0);
                    // Map for who's messaging who
                ...
                if(dataSnapshot.hasChild(mChatUser)){
                    ...
                    try {
                        // This will take care of when the user is typing
                        ...
                        Log.d("Chat Activity", "App crashed cause wasn't friends");
                    }
                }
            }
